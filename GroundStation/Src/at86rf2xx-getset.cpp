...
static const uint8_t dbm_to_tx_pow_868[] = {
    0x1d, 0x1c, 0x1b, 0x1a, 0x19, 0x18, 0x17, 0x15, 0x14, 0x13,
    0x12, 0x11, 0x10, 0x0f, 0x31, 0x30, 0x2f, 0x94, 0x93, 0x91,
    0x90, 0x29, 0x49, 0x48, 0x47, 0xad, 0xcd, 0xcc, 0xcb, 0xea,
    0xe9, 0xe8, 0xe7, 0xe6, 0xe4, 0x80, 0xa0};
static const uint8_t dbm_to_tx_pow_915[] = {
    0x1d, 0x1c, 0x1b, 0x1a, 0x19, 0x17, 0x16, 0x15, 0x14, 0x13,
    0x12, 0x11, 0x10, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x09, 0x91,
    0x08, 0x07, 0x05, 0x27, 0x04, 0x03, 0x02, 0x01, 0x00, 0x86,
    0x40, 0x84, 0x83, 0x82, 0x80, 0xc1, 0xc0};
...
static const int16_t tx_pow_to_dbm[] = {4,  4,  3,  3,  2,  2,  1,   0,
                                        -1, -2, -3, -4, -6, -8, -12, -17};
static const uint8_t dbm_to_tx_pow[] = {
    0x0f, 0x0f, 0x0f, 0x0e, 0x0e, 0x0e, 0x0e, 0x0d, 0x0d, 0x0d, 0x0c,
    0x0c, 0x0b, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05, 0x03, 0x00};
#else
static const int16_t tx_pow_to_dbm[] = {3,  3,  2,  2,  1,  1,  0,   -1,
                                        -2, -3, -4, -5, -7, -9, -12, -17};
static const uint8_t dbm_to_tx_pow[] = {
...
void AT86RF2XX::set_addr_short(uint16_t addr) {
  ...
  reg_write(AT86RF2XX_REG__SHORT_ADDR_0, addr_short[0]);
  reg_write(AT86RF2XX_REG__SHORT_ADDR_1, addr_short[1]);
}
...
uint8_t AT86RF2XX::get_chan() { return chan; }
...
#ifdef MODULE_AT86RF212B
at86rf2xx_freq_t AT86RF2XX::get_freq() { return freq; }
...
uint16_t AT86RF2XX::get_pan() { return pan; }
...
#else
  uint8_t txpower =
      reg_read(AT86RF2XX_REG__PHY_TX_PWR) & AT86RF2XX_PHY_TX_PWR_MASK__TX_PWR;
...
void AT86RF2XX::set_csma_max_retries(int8_t retries) {
  ...
  retries =
      (retries < 0) ? 7 : retries; /* max < 0 => disable CSMA (set to 7) */
...
inline void AT86RF2XX::_set_state(uint8_t state_) {
  ...
  uint8_t lol = reg_read(AT86RF2XX_REG__TRX_STATE);
