...
#define AT86RF2XX_OPT_PROMISCUOUS                                              \
  (0x0004)                                /**< promiscuous mode                \
                                           *   active */
#define AT86RF2XX_OPT_PRELOADING (0x0008) /**< preloading enabled */
#define AT86RF2XX_OPT_TELL_TX_START                                            \
  (0x0010) /**< notify MAC layer on TX                                         \
            *   start */
#define AT86RF2XX_OPT_TELL_TX_END                                              \
  (0x0020) /**< notify MAC layer on TX                                         \
            *   finished */
#define AT86RF2XX_OPT_TELL_RX_START                                            \
  (0x0040) /**< notify MAC layer on RX                                         \
            *   start */
#define AT86RF2XX_OPT_TELL_RX_END                                              \
  (0x0080) /**< notify MAC layer on RX                                         \
            *   finished */
#define AT86RF2XX_OPT_RAWDUMP                                                  \
  (0x0100) /**< pass RAW frame data to                                         \
            *   upper layer */
#define AT86RF2XX_OPT_SRC_ADDR_LONG                                            \
  (0x0200) /**< send data using long                                           \
            *   source address */
#define AT86RF2XX_OPT_USE_SRC_PAN                                              \
  (0x0400) /**< do not compress source                                         \
            *   PAN ID */
/** @} */
